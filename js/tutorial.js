...
window.onload = function() {
    ...
    function tabs() {
        ...
        if (args) {
            ...
            if (lastArg !== 'index' && lastArg !== 'tabs' && lastArg !== 'albumradio') {
                return;
           }
       }
        ...
        xhr.onreadystatechange = function () {
            ...
            wrapper.innerHTML = args[0] === 'index' ? '' : '<ul class="breadcrumb"><li><a href="spotify:app:album-radio:index">&laquo; Back to main page</a></li></ul>';
